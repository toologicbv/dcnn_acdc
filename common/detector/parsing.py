...
def do_parse_args():
    ...
    parser.add_argument('--model', default="rd1", choices=['rd1', 'rd1L', 'rd2', 'rd3', 'rd3L'])
    ...
    parser.add_argument('--root_dir', default=config_detector.root_dir)
    ...
    parser.add_argument('--type_of_map', choices=['u_map', 'e_map', "None"], default="e_map",
    ...
    if args.exper_dict == "exper_brier":
        args.exper_dict = config_detector.exper_dict_brier
    elif args.exper_dict == "exper_softdice":
        args.exper_dict = config_detector.exper_dict_softdice
    else:
        args.exper_dict = config_detector.exper_dict_centropy
...
run_dict = {'type_of_map': 'e_map',
            'model': "sdvgg11_bn",
            'exper_dict': config_detector.exper_dict_brier,
            'version': "v1",
            'root_dir': config_detector.root_dir,
            'fold_id': 0,
            'log_dir': None,
            'use_cuda': False,
            'cuda': False,
